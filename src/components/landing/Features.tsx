...
const features = [
  {
    ...
    description:
      "Execute tasks in milliseconds with our optimized AI engine. No more waiting around.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Customize everything to match your unique process. Build your perfect workflow.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Work together seamlessly with real-time sync and smart permission controls.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Gain insights with detailed reports and visualizations of your productivity.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Connect with 100+ tools you already use. Slack, GitHub, Notion, and more.",
  },
];
